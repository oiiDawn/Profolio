...
- **Scope and mode:** `app/page.tsx` is a Read-first personal calling-card homepage. It introduces Jiaming through work and thought without behaving like a navigation shell, resume page, job-search landing page, or conversion funnel.
...
- **Non-literal comp content:** The hero introduction and future Writing/How I Work text are layout placeholders; official Stack icons still require verification; the likeness-based logo is intentionally omitted until a reference photo exists. Implement these from confirmed content and assets rather than rasterizing or copying generated text and glyphs.
- **Boundaries and unresolved assets:** Do not expand case studies inside the homepage or use cards, thumbnails, timeline storytelling, section numbers, CTA blocks, or persistent navigation. Real logo reference, final CV, final writing and How I Work content, and verified official Stack icons remain pending. Dedicated Selected Work page composition is intentionally outside this brief.
