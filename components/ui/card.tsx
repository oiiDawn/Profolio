...
const cardVariants = cva(
  "group/card relative flex flex-col gap-4 overflow-hidden rounded-none py-4 text-sm text-card-foreground has-[>img:first-child]:pt-0 data-[size=sm]:gap-3 data-[size=sm]:py-3 *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none",
  {
    variants: {
      variant: {
